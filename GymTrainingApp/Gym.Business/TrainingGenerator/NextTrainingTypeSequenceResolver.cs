...
{
    public class NextTrainingTypeSequenceResolver : INextTrainingTypeSequenceResolver
    {
        private readonly ITrainingRepository _trainingRepository;
        private readonly ITrainingTypeSequenceRepository _trainingTypeSequenceRepository;

        public NextTrainingTypeSequenceResolver(ITrainingRepository trainingRepository,
        ...
        public int GetNextTrainingTypeSequenceId(int idTrainingPlan, int idTrainingType)
        {
